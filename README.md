...
## Requirements
Python 3.8+ (project was tested with Python 3.7–3.11; for local Stable Diffusion GPU generation use a recent Python and CUDA-enabled PyTorch).
...
ai_menu.py — AI image generation UI. Supports multiple services: local (diffusers / Stable Diffusion), Stable Horde, Hugging Face inference, Fal.ai, OpenAI, Stability AI and custom endpoints. Handles prompts, negative prompts, generation settings and history; saves results to ai_generated_images and auto-loads them to the canvas.
